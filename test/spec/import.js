...
describe('import test: ', () => {
    ...
    it('simple import', done => {
        iocInstance.getComponent('importA', importIns => {
    ...
    it('nested import', done => {
        iocInstance.getComponent('importNest', nest => {
    ...
    it('nested import with auto and singleton', done => {
        iocInstance.getComponent('importNest', nest1 => {
            iocInstance.getComponent('importNest', nest2 => {
